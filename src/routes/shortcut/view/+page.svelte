<script lang="ts">
	...
	const manualShortcuts = $derived(shortcuts.filter((shortcut) => !shortcut.autoGenerated));
	const autoShortcuts = $derived(shortcuts.filter((shortcut) => shortcut.autoGenerated));
</script>
